...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Black Theme Options', 'optionsframework'),
		'menu_title' => __('Theme Options', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'sktblack-options',
...
function of_admin_head() {
	...
	do_action( 'skt_black_optionsframework_custom_scripts' );
}
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
        ...
        <div style="width:25%; float:right;" class="postbox-container side">
            <div class="meta-box-sortables ui-sortable">
                <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Our Themes','skt-black'); ?></span></h3>
                    <div class="inside">
                ...
                <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Forum','skt-black');?></span></h3>
                    <div class="inside">
                        <p><em><?php _e('You can post your questions at our','skt-black'); ?> <a href="<?php echo esc_url('http://www.sktthemes.net/forums/');?>" target="_blank"><?php _e('support forum','skt-black'); ?></a></strong></em></p>
                    </div>
                </div>
                <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Documentation','skt-black'); ?></span></h3>
                    <div class="inside">
                        <p><em><?php _e('For documentation and support check this link','skt-black'); ?> : <strong><a href="<?php echo esc_url(SKT_THEME_DOC); ?>" target="_blank"><?php _e('SKT Black Theme Documentation','skt-black'); ?></a></strong></em></p>
                    </div>
                </div>
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'SKT Black Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=sktblack-options' )
		));
}

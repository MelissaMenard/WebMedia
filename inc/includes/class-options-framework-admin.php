...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Theme Options', 'skt_black' ),
			'menu_title' => __( 'Theme Options', 'skt_black' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'skt_black-options',
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox"  style="width:72%; float:left;">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'skt_black' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'skt_black' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'skt_black' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
            ...
            <div class="meta-box-sortables ui-sortable">
                <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Our Themes','skt_black'); ?></span></h3>
                    <div class="inside">
                 ...
                 <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Forum','skt_black'); ?></span></h3>
                    <div class="inside">
                        <p><em><?php _e('You can post your questions at our','skt_black'); ?> <a href="<?php echo esc_url('http://www.sktthemes.net/forums/');?>" target="_blank"><strong><?php _e('support forum','skt_black'); ?></a></strong></em></p>
                    </div>
                </div>
                
                <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Documentation','skt_black'); ?></span></h3>
                    <div class="inside">
                        <p><em><?php _e('For documentation and support check this link','skt_black'); ?> : <strong><a href="<?php echo esc_url(SKT_THEME_DOC); ?>" target="_blank">SKT Black Documentation</a></strong></em></p>
                    </div>
                </div>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'skt_black' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'skt_black' ), 'updated fade' );
	}

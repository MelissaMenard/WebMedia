...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt_black' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt_black' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt_black' ),
		'repeat'    => __( 'Repeat All', 'skt_black' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt_black' ),
		'top center'    => __( 'Top Center', 'skt_black' ),
		'top right'     => __( 'Top Right', 'skt_black' ),
		'center left'   => __( 'Middle Left', 'skt_black' ),
		'center center' => __( 'Middle Center', 'skt_black' ),
		'center right'  => __( 'Middle Right', 'skt_black' ),
		'bottom left'   => __( 'Bottom Left', 'skt_black' ),
		'bottom center' => __( 'Bottom Center', 'skt_black' ),
		'bottom right'  => __( 'Bottom Right', 'skt_black')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt_black' ),
		'fixed'  => __( 'Fixed in Place', 'skt_black')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt_black' ),
		'italic'      => __( 'Italic', 'skt_black' ),
		'bold'        => __( 'Bold', 'skt_black' ),
		'bold italic' => __( 'Bold Italic', 'skt_black' )
		);
